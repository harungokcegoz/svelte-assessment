...
<div class="mx-auto w-full max-w-7xl rounded-lg bg-white p-8 shadow sm:px-6">
	<div class="border-b border-gray-200 pb-5">
		<h3 class="title-large">Welcome to Todo App</h3>
		<p class="text-secondary mt-2 max-w-4xl">
			Organize your tasks efficiently with our modern todo application.
		</p>
	</div>

	<div class="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-3">
		<StatsCard label="Total Todos" value={totalTodos} />
		<StatsCard label="Completed" value={completedTodos} textColor="text-green-600" />
		<StatsCard label="Remaining" value={incompleteTodos} textColor="text-blue-600" />
	</div>
